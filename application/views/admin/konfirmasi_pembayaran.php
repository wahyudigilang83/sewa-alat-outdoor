                                    ...
                                    <form method="POST" action="<?php echo base_url('admin/transaksi/cek_pembayaran') ?>">
                                        ...
                                        <?php foreach($pembayaran as $pmb) : ?>
                                            ...
                                            <div class="form-check form-switch ml-3">
                                              ...
                                              <input class="form-check-input ml-4" type="hidden" role="switch"  value="<?php echo $pmb->id_rental ?>" name="id_rental">
                                              <input class="form-check-input ml" type="checkbox" role="switch"  value="1" name="status_pembayaran">
                                              <label class="form-check-label" for="flexSwitchCheckDefault">Konfirmasi Pembayaran</label>
                                            </div>
                                            <hr>
                                            <button type="submit" class="btn btn-sm btnp-primary">Simpan</button>
